...
Route::post('restaurant_expense_details/{uuid}/update_restaurant_expense_details', [\App\Http\Controllers\RestaurantExpenseController::class, 'update_restaurant_expense_details']);
