...
<div class="print-wrapper" style="padding: 2px;">
    ...
    <div class="ticket-items-list" style="width: 100%;">
        ...
        @if($order->items && count($order->items) > 0)
            <div class="section-divider">Menus</div>
            <table class="invoice-table" style="font-size: 6.8pt !important; width: 100%; table-layout: fixed; border-collapse: collapse; margin-bottom: 5px;">
                <thead>
                ...
                @foreach($order->items as $index => $item)
                    <tr style="border-bottom: 1px dashed #dddddd; width: 100%; {{ $item->is_rejected ? 'color: #777777;' : '' }}">
                        <td class="fw-bold text-uppercase" style="padding: 3px 0; vertical-align: top; word-wrap: break-word;">
                        ...
                        <td class="text-end fw-bold" style="padding: 3px 0; vertical-align: top;">
        ...
        @if($order->drinks && count($order->drinks) > 0)
            <div class="section-divider" style="margin-top: 5px;">Boissons</div>
            <table class="invoice-table" style="font-size: 6.8pt !important; width: 100%; table-layout: fixed; border-collapse: collapse;">
                <thead>
                <tr style="border-bottom: 1px solid #000000; width: 100%;">
                    <th style="width: 45%; padding: 2px 0; text-align: left;">Désignation</th>
                    <th style="width: 12%; padding: 2px 0;" class="text-center">Qté</th>
